...
function TransactionsProvider({ children }) {
    ...
    const [isInsightsLoading, setIsInsightsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const refreshInsights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentTransactions)=>{
        ...
        try {
            ...
            const totalExpenses = currentTransactions.filter((t)=>t.type === 'expense').reduce((acc, t)=>acc + t.amount, 0);
    ...
    const refreshBudgetFeedback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (currentTransactions, currentBudget)=>{
        ...
        try {
            const totalExpenses = currentTransactions.filter((t)=>t.type === 'expense' && new Date(t.date).getMonth() === new Date().getMonth()).reduce((acc, t)=>acc + t.amount, 0);
...
const FinancialHealth = ()=>{
    const { transactions, insights, cashflowMessage, isInsightsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$transactions$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransactions"])();
    const totalIncome = transactions.filter((t)=>t.type === 'income').reduce((acc, t)=>acc + t.amount, 0);
    const totalExpenses = transactions.filter((t)=>t.type === 'expense').reduce((acc, t)=>acc + t.amount, 0);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    isInsightsLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            insights.length === 0 && !isInsightsLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-muted-foreground",
...
;
const BudgetTracker = ()=>{
    const { transactions, budget, setBudget, budgetFeedback, isFeedbackLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$transactions$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransactions"])();
...
const BudgetSetup = ()=>{
    const { setBudget } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$transactions$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransactions"])();
...
;
const Dashboard = ()=>{
    const { transactions, budget } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$transactions$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransactions"])();
...
//# sourceMappingURL=src_e3dd34d2._.js.map